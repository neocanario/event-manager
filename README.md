...
The following screenshot shows a RSS feed reader (Feedly) displaying items from the **Eventbrite Blog RSS feed**, with each item linking to a corresponding news article in this app hosted on Firebase:
